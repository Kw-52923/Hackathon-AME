...
function toggleVoiceNav() {
    ...
    alert("Voice Navigation: Say your destination\n\nExample: 'Go to nearest pharmacy'");
}

function toggleEyeNav() {
    console.log("👁️ EYE NAVIGATION ACTIVATED");
    alert("Eye Control Active\n\nLook at the place on the map to select it");
}

function markDestination() {
    console.log("📍 MARKING DESTINATION");
    alert("Destination marked ✓\n\nCalculating accessible route...");
}
